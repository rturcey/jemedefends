    ...
    def _db_to_letter(db_letter: models_sqlc.Letter) -> Letter:
        return Letter(
            ...
            buyer_address=Address(
                line1=db_letter.buyer_address_line1,
                line2=db_letter.buyer_address_line2,
            ...
            seller_address=Address(
                line1=db_letter.seller_address_line1,
                line2=db_letter.seller_address_line2,
        ...
        try:
            ...
            return [
                Letter(
                    ...
                    buyer_address=Address(
                        line1=letter.buyer_address_line1,
                        line2=letter.buyer_address_line2,
                    ...
                    seller_address=Address(
                        line1=letter.seller_address_line1,
                        line2=letter.seller_address_line2,
