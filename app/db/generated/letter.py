...
RETURNING id, buyer_name, buyer_email, buyer_address_line1, buyer_address_line2, buyer_postal_code, buyer_city, buyer_country, seller_name, seller_email, seller_address_line1, seller_address_line2, seller_postal_code, seller_city, seller_country, purchase_date, product_name, product_price, order_reference, used, digital, defect_type, defect_description, content, status, created_at, updated_at
"""
...
class CreateLetterParams:
    ...
    buyer_address_line_2: str | None
    buyer_postal_code: str
    buyer_city: str
    buyer_country: str
    seller_name: str
    seller_address_line_1: str
    seller_address_line_2: str | None
...
SELECT id, buyer_name, buyer_email, buyer_address_line1, buyer_address_line2, buyer_postal_code, buyer_city, buyer_country, seller_name, seller_email, seller_address_line1, seller_address_line2, seller_postal_code, seller_city, seller_country, purchase_date, product_name, product_price, order_reference, used, digital, defect_type, defect_description, content, status, created_at, updated_at
FROM letter
WHERE id = :p1\\:\\:uuid
LIMIT 1
"""
...
class AsyncQuerier:
    ...
    async def create_letter(self, arg: CreateLetterParams) -> models.Letter | None:
        ...
        return models.Letter(
            ...
            buyer_name=row[1],
            buyer_email=row[2],
            buyer_address_line1=row[3],
            buyer_address_line2=row[4],
            buyer_postal_code=row[5],
            buyer_city=row[6],
            buyer_country=row[7],
            seller_name=row[8],
            seller_email=row[9],
            seller_address_line1=row[10],
            seller_address_line2=row[11],
