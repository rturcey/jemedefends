  ...
  class FormManager {
    ...
    fillTestData() {
      const testData = {
        ...
        buyer_address_line1: "123 rue de la République",
        buyer_postal_code: "75001",
        buyer_city: "Paris",
        buyer_country: "FR",
        seller_name: "TechStore SARL",
        seller_address_line1: "456 avenue du Commerce",
    ...
    updateProgress() {
      ...
      STEPS.forEach((step) => {
        ...
        const requiredFields = step.fields.filter((f) => !f.includes("_line2"));
    ...
    async submitForm() {
      try {
        ...
        const result = await fetchJSON(
          `${API_BASE}/${encodeURIComponent(this.formSlug)}/submit`,
