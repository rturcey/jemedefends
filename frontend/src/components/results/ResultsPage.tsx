...
const SignaturePad: React.FC<SignaturePadProps> = ({ onSignatureChange, disabled }) => {
  ...
  return (
    <div className="space-y-2">
      <div className="relative border-2 border-dashed border-blue-200 rounded-2xl bg-white overflow-hidden">
        <canvas
          ref={canvasRef}
        ...
        {isEmpty && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span className="text-xs sm:text-sm text-gray-400">Signez ici</span>
          </div>
        )}
      </div>
      {!isEmpty && (
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-xl">
            <div className="flex justify-between text-sm text-gray-700 mb-2">
              ...
              <span className="font-semibold">{formatEuro(basePrice)}</span>
            </div>
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h5 className="font-bold text-gray-900">PDF seul</h5>
                </div>
                <span className="text-lg font-bold text-blue-800">{formatEuro(PRICES.pdf)}</span>
              </div>
            ...
            >
              <div className="absolute -top-2 -right-2 bg-indigo-600 text-white text-xs px-2 py-0.5 rounded-full font-bold">
                On fait tout !
              </div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h5 className="font-bold text-gray-900">PDF + Envoi recommandé (LRAR papier)</h5>
                </div>
              ...
              <ul className="text-xs text-slate-800 space-y-1 ml-6">
                ...
                <li>✓ Signature électronique intégrée</li>
                <li>
                  ✓ <strong>Impression et envoi recommandé AR papier</strong>
                </li>
    ...
    <>
      ...
      <div className="sm:hidden space-y-2">
        {(open ? items : items.slice(0, mobileVisible)).map((it, i) => (
          <div key={`m-${i}`} className="flex items-start gap-2 text-[15px] leading-5">
            {it}
          </div>
        ))}
      ...
      <div className="hidden sm:block space-y-2">
        {items.map((it, i) => (
          <div key={`d-${i}`} className="flex items-start gap-2 text-[15px] leading-6">
            {it}
          </div>
        ))}
      </div>
...
export default function ResultsPage(): JSX.Element {
  ...
  const { loading, generateFreeVersion, previewPdf, fetchAndCacheLetter } = useResultsPage();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 sm:py-12 pb-28 sm:pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="hidden sm:inline-flex items-center gap-2 bg-green-100 text-green-800 px-5 py-2 rounded-full font-semibold mb-3 text-sm shadow-sm">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-5">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
              <div className="flex items-start gap-3">
                <FileText className="w-5 h-5 text-gray-600 mt-0.5" aria-hidden="true" />
                <div>
                  <span className="font-semibold text-gray-900">Version gratuite disponible</span>
                  <p className="text-xs text-gray-600 mt-0.5">
                    Texte brut • Vous gérez tout (formatage, impression, signature, envoi LRAR) •
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 mb-4 items-stretch">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <div className="h-full bg-white rounded-2xl p-4 sm:p-5 ring-1 ring-orange-100 shadow-lg hover:shadow-xl transition-shadow flex flex-col">
              <div className="mb-3 sm:mb-4">
                <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3 sm:block">
                  <div className="col-span-2 flex items-center gap-2 sm:justify-center sm:mb-3">
                    <div className="w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-sm">
                  ...
                  <div className="text-right sm:text-center">
                    <div className="flex items-baseline justify-end sm:justify-center gap-1.5">
                      <span className="text-3xl sm:text-5xl font-extrabold tracking-tight text-orange-600">
                        12,99€
                      </span>
              ...
              <div className="mx-auto w-full max-w-[290px] sm:max-w-none flex items-center justify-center gap-2 text-[12px] sm:text-[13px] text-emerald-900 bg-emerald-50/70 border border-emerald-100 rounded-lg sm:rounded-xl px-2.5 sm:px-3 py-1.5 mb-3 sm:mb-4">
              ...
              <MobileList
                ...
                items={[
                  <>
                    <Check className="w-5 h-5 text-orange-600 mt-0.5 shrink-0" aria-hidden="true" />
                  ...
                  <>
                    <Award className="w-5 h-5 text-orange-600 mt-0.5 shrink-0" aria-hidden="true" />
                    <span className="text-slate-800">
          ...
          >
            <div className="h-full flex flex-col">
              <div className="flex-1 bg-white rounded-2xl p-4 sm:p-5 ring-1 ring-slate-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="mb-3 sm:mb-4">
                  <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3 sm:block">
                    <div className="col-span-2 flex items-center gap-2 sm:justify-center sm:mb-3">
                      <div className="w-8.5 h-8.5 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center">
                    ...
                    <div className="text-right sm:text-center">
                      <div className="flex items-baseline justify-end sm:justify-center gap-1.5">
                        <span className="text-2xl sm:text-3xl font-bold text-blue-800">2,99€</span>
                        <span className="text-xs sm:text-sm text-slate-500 line-through">
                ...
                <MobileList
                  ...
                  items={[
                    <>
                      <Check className="w-5 h-5 text-blue-700 mt-0.5 shrink-0" aria-hidden="true" />
                    ...
                    <>
                      <Printer className="w-4 h-4 mt-0.5 shrink-0" aria-hidden="true" />
              ...
              <div className="hidden sm:block">
                ...
                >
                  <h4 className="font-semibold text-blue-800 mb-1">Aperçu du PDF</h4>
        ...
        <div className="mt-4 mb-4">
          <div className="rounded-2xl bg-white ring-1 ring-emerald-100 px-5 py-3 shadow-sm text-[15px]">
            <div className="flex items-start gap-3 max-w-3xl mx-auto text-left">
              <div
              ...
              <p className="text-slate-700 leading-6">
                ...
                produit une
                <span className="font-semibold"> preuve d'envoi</span> et un
                <span className="font-semibold"> accusé de réception</span> opposables. Vos
                justificatifs sont
        ...
        >
          <h3 className="font-bold text-xl text-blue-800 mb-2">Pas encore décidé ?</h3>
        ...
        >
          ...
          <div className="pt-3 border-t border-gray-200">
            ...
            <p className="leading-relaxed">
              Les informations sont basées sur le Code de la consommation français. Pour un conseil
