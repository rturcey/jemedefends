...
export default function HomeHeroLeft() {
    // ❌ SUPPRIMER le state isLoaded et le useEffect
    ...
    // ANIMATIONS DÉSACTIVÉES pour prioriser les skeletons
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="visible" // Toujours visible, pas de condition
        >
            {/* ===============================================
          ...
          =============================================== */}
            <motion.div variants={itemVariants} className="mb-8 md:mb-5">
                ...
                <div className="md:hidden">
                    <div
                        className="flex items-center gap-3 px-5 py-4 bg-gradient-to-r from-green-50 via-emerald-50 to-green-50 border border-green-200 rounded-2xl shadow-md">
                        <div
                        ...
                        <div className="flex-1">
                            <div
                                className="text-green-900 font-bold text-[17px] leading-tight">
                                Service 100% gratuit
                            </div>
                ...
                <div className="hidden md:flex flex-wrap items-center gap-3">
                    <div
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 border border-green-200 rounded-full">
                        <Sparkles className="w-3.5 h-3.5 text-green-600"/>
                        <span className="text-sm font-semibold text-green-900">Service Gratuit</span>
                    </div>
                    <div
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-full">
                        <Zap className="w-3.5 h-3.5 text-blue-600"/>
                        <span className="text-sm font-semibold text-blue-900">Sans inscription</span>
                    </div>
                    <div
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 border border-purple-200 rounded-full">
          ...
          =============================================== */}
            <motion.div variants={itemVariants} className="mb-5 md:mb-5">
              ...
              Obtenez{' '}
                        <span
                            className="bg-gradient-to-r from-blue-700 to-indigo-600 bg-clip-text text-transparent">
                réparation
              </span>
            </span>
                    <span
                        className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-600 font-semibold mt-3">
          ...
          =============================================== */}
            <motion.div variants={itemVariants} className="mb-5 md:mb-5">
                <p className="text-[15px] sm:text-base md:text-lg text-gray-700 max-w-2xl leading-relaxed">
                    ...
                    <span
                        className="inline-flex items-center px-2.5 py-1 bg-green-50 rounded-lg font-bold text-green-900 text-sm">
            ...
            <motion.div variants={itemVariants} className="mb-6 md:mb-5">
                <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-2xl">
                    {[
                        ...
                        >
                            <div
                                className="flex items-center justify-center w-10 h-10 bg-blue-50 rounded-lg">
                                {item.icon}
                            </div>
          ...
          =============================================== */}
            <motion.div variants={itemVariants} className="md:hidden mt-2">
                <div className="relative">
                    ...
                    <div
                        className="absolute inset-x-0 -bottom-8 h-20 bg-gradient-to-b from-transparent via-blue-50/30 to-blue-50/50 pointer-events-none"/>

                    {/* Mini-rappel confiance */}
                    <div
                        className="flex items-center justify-center gap-2 text-xs text-gray-600 pt-4 pb-6">
