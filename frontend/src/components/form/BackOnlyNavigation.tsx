// src/components/eligibility/BackOnlyNavigation.tsx - Navigation spécifique éligibilité
'use client';
...
const BackOnlyNavigation: React.FC<BackOnlyNavigationProps> = ({
  ...
  return (
    <>
      ...
      {/* Mobile - NAVIGATION FIXE TOUJOURS VISIBLE */}
      <motion.div
        ...
        <div className="relative px-4 py-3">
          <div className="max-w-[640px] mx-auto">
            <div className="flex items-center justify-between gap-3">
              ...
              {/* Espace équilibré (invisible mais maintient la symétrie) */}
