        ...
        <div className={`space-y-3 ${className}`}>
            ...
            <AnimatePresence mode="wait">
                ...
                {magicState === 'improving' && (
                    ...
                    >
                        <div
                            className="animate-spin w-5 h-5 border-2 border-blue-600 border-t-transparent rounded-full"></div>
                ...
                {needsChoice && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span
                                className="font-medium">Suggestion d'amélioration</span>
                        </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-3">
                            ...
                            <div className="text-sm text-gray-700 space-y-2">
                                <p>
                                    Or, ce <span
                                    className="font-medium">{isDigital ? 'service' : 'bien'}</span>{' '}
                                    présente un{' '}
                                ...
                                <div
                                    ...
                                    <span
                                        className="font-semibold text-gray-900">{improvedText}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-3 text-xs">
                            <div className="flex items-start gap-2">
                                <div
                                    className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
                                <div>
                            ...
                            <div className="flex items-start gap-2">
                                <div
                                    className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                                <div>
