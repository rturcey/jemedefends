    ...
    <section className="step-section p-0" role="tabpanel" aria-labelledby="purchase-title">
      ...
      {showModal && (
        ...
        >
          ...
          <div className="relative w-full sm:max-w-xl bg-white rounded-2xl shadow-2xl border border-gray-200 mx-2 sm:mx-0 p-5 sm:p-6 animate-[fadeIn_.2s_ease]">
            <div className="flex items-start gap-3">
              <div className="shrink-0 p-2 rounded-xl bg-blue-50 border border-blue-100">
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12 3l4 4-9 9H3v-4l9-9Zm7.7 3.3l-1 1-4-4 1-1a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4ZM5 21h14v-2H5v2Z" />
                </svg>
              </div>
              <div className="flex-1">
                <h3
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Nous vous suggérons une désignation claire et conforme, telle qu’elle apparaîtra
                  dans votre lettre.
                </p>
              </div>
              <button
            ...
            <div className="mt-4 space-y-3">
              ...
              {!loading && apiError && (
                <div className="p-3 rounded-xl border border-amber-300 bg-amber-50 text-amber-900 text-sm">
                  {apiError} — Vous pouvez continuer sans reformulation.
                  <div className="mt-2">
                    <button
                      type="button"
                      onClick={() => {
                ...
                <>
                  <div className="p-3 rounded-xl border border-blue-200 bg-blue-50">
                    <p className="text-sm text-blue-900">
                      <span className="font-semibold">Suggestion :</span> {proposal || '—'}
                    </p>
                  </div>
