...
export default function TrustSovereigntySection() {
    ...
    return (
        <section
            id="fiabilite"
            className="relative overflow-hidden py-6 md:py-12 lg:py-20 md:h-screen md:flex md:items-center md:justify-center section-scroll-target"
        >
            <Container className="relative z-10">
                <Reveal immediate>
                    <div
                        className="max-w-3xl mx-auto text-center mb-6 md:mb-12 lg:mb-16">
                        <div className="mb-8 md:mb-10 lg:mb-12">
                            <Badge tone="green">
                                {isMobile ? 'Questions & garanties' : 'Confiance & souveraineté'}
                            </Badge>
                        </div>
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 mb-2 md:mb-3">
                            {isMobile ? 'Vos questions, nos garanties 🔒' : 'Vos données, notre exigence 🇫🇷'}
                        </h2>
                        <p className="text-xs sm:text-sm md:text-base lg:text-lg text-slate-600 text-center">
                            {isMobile
                ...
                <div className="md:hidden mb-6">
                    <h3 className="text-sm font-semibold text-gray-900 mb-3 px-2">Sécurité
                        & conformité</h3>
                    <div className="grid grid-cols-2 gap-3">
                        <Reveal delay={0.05}>
                            <div
                                ...
                                <div
                                    className="w-8 h-8 rounded-lg bg-green-50 text-green-600 flex items-center justify-center flex-shrink-0">
                  ...
                  Données sécurisées
                        ...
                        <Reveal delay={0.14}>
                            <div
                                className="flex items-center gap-2 p-3 bg-white rounded-xl border border-gray-200 shadow-sm">
                                <div
                                    className="w-8 h-8 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center flex-shrink-0">
                ...
                <div
                    className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
                    <Reveal delay={0.1}>
                        <article
                            className="h-full rounded-2xl border border-gray-200 bg-white p-4 md:p-6 hover:shadow-lg transition-shadow">
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-green-50 text-green-700 flex items-center justify-center flex-shrink-0">
                    ...
                    <Reveal delay={0.15}>
                        <article
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-blue-50 text-blue-700 flex items-center justify-center flex-shrink-0">
                            ...
                            <p className="mt-2 md:mt-3 text-xs md:text-sm text-gray-700 leading-relaxed">
                                Processeur <strong>Stancer</strong> (français). Sécurité
                                bancaire maximale, 0%
                    ...
                    <Reveal delay={0.2}>
                        <article
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-purple-50 text-purple-700 flex items-center justify-center flex-shrink-0">
                            ...
                            <p className="mt-2 md:mt-3 text-xs md:text-sm text-gray-700 leading-relaxed">
                                <strong>Collecte minimale</strong>. Nous ne conservons
                                aucune donnée après
                    ...
                    <Reveal delay={0.25}>
                        <article
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-orange-50 text-orange-700 flex items-center justify-center flex-shrink-0">
                            ...
                            <p className="mt-2 md:mt-3 text-xs md:text-sm text-gray-700 leading-relaxed">
                                Notre équipe répond par
                                email pour toute option
                                payante. <strong>Contactez-nous</strong>.
                            </p>
                        </article>
                    </Reveal>
                </div>
                ...
                {isMobile && (
                    <div className="mb-6">
                        <h3 className="text-sm font-semibold text-gray-900 mb-3 px-2">Questions
                            principales</h3>
                        ...
                        <div className="space-y-2">
                            {FAQ_ITEMS.map((item, index) => (
                                <Reveal key={item.id} delay={index * 0.03}>
                                    <div
                                        className="rounded-xl border border-gray-200 p-3 hover:border-blue-300 hover:shadow-sm transition-all bg-white">
                                        <button
