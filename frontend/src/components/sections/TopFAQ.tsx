...
const FAQ_ITEMS = [
    ...
    },
    {
        ...
        answer: "Version gratuite : 0€. PDF mis en forme : quelques euros. Premium (avec envoi recommandé) : prix modique pour le service complet.",
        category: 'Service',
        iconType: 'prix',
    },
];
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    <div
                                        className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-blue-50 text-blue-600 flex-shrink-0">
                                        {getContextualIcon(item.iconType)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <h3 className="font-medium text-sm md:text-base text-gray-900 leading-tight">{item.question}</h3>
                                        <span
                                            className="text-[10px] md:text-xs text-gray-500">{item.category}</span>
                                    </div>
                                </div>
                                {expandedId === item.id ? (
                                    <ChevronUp
