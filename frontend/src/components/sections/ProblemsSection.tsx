    ...
    >
        <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
            ...
            <div className="flex-1 min-w-0">
                ...
                {problem.legalHint &&
                    <p className="text-xs text-gray-500 mt-1">{problem.legalHint}</p>}
            </div>
        </div>
        ...
        <div
            className="flex items-center justify-between mt-3 md:mt-4 pt-3 border-t border-gray-100">
                ...
                <Reveal>
                    <div className="text-center mb-6 md:mb-10">
                        ...
                        <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
                            Découvrez nos guides spécialisés selon le type de produit ou
                            service
                        </p>
                    </div>
                </Reveal>
