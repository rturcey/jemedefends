    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <div className="relative bg-gradient-to-br from-surface-soft to-white">
                <div
                    className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 opacity-40"/>
                <div className="absolute inset-0 opacity-20">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-blue-100/30 to-purple-100/30"/>
                    <div
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <Reveal delay={0.1}>
                            <div
                                ...
                                <div
                                    className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full text-xs md:text-sm font-medium text-gray-700">
                                    <CheckCircle
                                ...
                                <div
                                    className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full text-xs md:text-sm font-medium text-gray-700">
                                    <Clock
                                        className="w-3 h-3 md:w-4 md:h-4 text-blue-600"/>2
                                    minutes chrono
                                </div>
                                <div
                                    className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full text-xs md:text-sm font-medium text-gray-700">
