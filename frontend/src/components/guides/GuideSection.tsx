        ...
        <section id={section.id} className="scroll-mt-24 mb-8">
            <div
                ...
                {sectionType === 'timeline' && section.steps ? (
                    <ProcedureSteps steps={convertStepsToProcedureSteps(section.steps)}
                                    accent="blue"/>
                    ...
                    <div
                        className="prose prose-gray prose-lg max-w-none prose-headings:text-gray-900 prose-a:text-blue-600 prose-strong:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed">
