// Composants existants (garder)
export { default as GuideCard } from './GuideCard';
export { default as GuideNavigation } from './GuideNavigation';
...
export { default as GuideDisclaimer } from './GuideDisclaimer';
export { default as ProcedureSteps } from './ProcedureSteps';
export { default as GuideTOCMobile } from './GuideTOCMobile';
