...
export const OutlineButton = (props: Omit<CombinedButtonProps, 'variant'>) => (
  <Button variant="outline" {...props} />
);

export const GhostButton = (props: Omit<CombinedButtonProps, 'variant'>) => (
...
/**
 * Hook pour gérer l'état de chargement des boutons
 */
