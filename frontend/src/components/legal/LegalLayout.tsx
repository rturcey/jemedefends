        ...
        <div className="min-h-screen">
            <main className="mx-auto w-full max-w-4xl px-4 py-6 md:py-10">
                ...
                <div className="w-full max-w-3xl mx-auto">
                    ...
                    <div
                        className="bg-blue-50 border border-blue-200 rounded-2xl p-6 text-center flex flex-col items-center">
                        <h3 className="font-semibold text-blue-900 mb-2">🚀 Besoin d'agir
                            ?</h3>

                        <p className="text-sm text-blue-700 mb-4">
                            Générez gratuitement votre lettre fondée sur le Code de la
                            consommation !
                        </p>
                    ...
                    <div
                        className="mt-8 p-5 bg-green-50 rounded-xl border border-green-200">
                        <h3 className="font-semibold text-green-900 mb-3 text-center">💡
                            Transparence</h3>
                        <div
                            className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-green-800">
