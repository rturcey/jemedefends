                ...
                >
                    <LegalSection id="editeur" title="🏢 Éditeur du site">
                        <div className="bg-gray-50 rounded-xl p-4">
                            <div className="space-y-0">
                                <KeyValue label="Dénomination"
                                          value="Richard Turcey – Entrepreneur individuel"/>
                                ...
                                <KeyValue label="Code APE"
                                          value="62.01Z – Programmation informatique"/>
                                <KeyValue label="Adresse"
                                          value="2 Rue André Bouillar, 40220 Tarnos, France"/>
                                <KeyValue
                                    label="Contact"
                                    value={
                                        <a
                                ...
                                />
                                <KeyValue label="Responsable de publication"
                                          value="Richard Turcey"/>
                            </div>
                        </div>
                        <div
                            className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                            <p className="text-sm text-yellow-800">
                                <strong>ℹ️ Important :</strong> Ce site fournit des
                                informations et des outils
                                fondés sur le Code de la consommation. Il ne constitue
                    ...
                    <LegalSection id="donnees" title="🔒 Données personnelles">
                        <p>
                            ...
                            génération de votre
                            lettre. Hébergement en France (Scaleway), paiements via
                            Stancer, envois postaux par
                            Merci Facteur.
                        </p>
                        <p>
                    ...
                    <LegalSection id="propriete" title="⚖️ Propriété intellectuelle">
                        <p>
                            Les contenus du site (textes, interfaces, design, logo) sont
                            protégés par le droit
                            d'auteur. Toute reproduction sans autorisation est
                            interdite.
                        </p>
                        <p>
                            Les extraits d'articles de loi appartiennent au domaine
                            public, mais leur sélection et
                    ...
                    <LegalSection id="responsabilite" title="Responsabilité">
                        <p>
                            Nous mettons à disposition des informations fiables et à
                            jour, mais ne garantissons
                            pas l'issue d'un litige. L'utilisateur reste responsable de
                            ses démarches.
                        </p>
                        <p>Les liens externes sont fournis à titre informatif, sans
                            garantie de contenu.</p>
                    </LegalSection>
