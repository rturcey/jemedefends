...
const ProblemsSection = dynamic(() => import('@/components/sections/ProblemsSection'), {
  loading: () => (
    <section className="min-h-screen md:h-[calc(100vh-5rem)] flex items-center justify-center bg-white">
      <Container>
...
const ProcessSection = dynamic(() => import('@/components/sections/ProcessSection'), {
  loading: () => (
    <section className="min-h-screen md:h-[calc(100vh-5rem)] flex items-center justify-center bg-gray-50">
      <Container>
        <div className="space-y-8 w-full max-w-6xl mx-auto">
...
const TrustSovereigntySection = dynamic(
  ...
  {
    loading: () => (
      <section className="min-h-screen md:h-[calc(100vh-5rem)] flex items-center justify-center bg-blue-50">
        <Container>
          <div className="space-y-8 w-full max-w-6xl mx-auto">
