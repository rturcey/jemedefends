    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center">
      <Container variant="form" className="py-6 md:py-12">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-center gap-2 md:gap-6 mb-5 md:mb-8 text-xs md:text-sm text-gray-600 px-4 w-fit mx-auto">
          ...
          <div className="hidden md:grid md:grid-cols-3 gap-4 lg:gap-6 mt-12">
            <div className="bg-white rounded-xl p-5 lg:p-6 shadow-sm border border-gray-200">
              <Shield className="w-7 h-7 lg:w-8 lg:h-8 text-blue-600 mx-auto mb-3" />
            ...
            <div className="bg-white rounded-xl p-5 lg:p-6 shadow-sm border border-gray-200">
              <Lock className="w-7 h-7 lg:w-8 lg:h-8 text-green-600 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">
                Données sécurisées
              </h3>
              <p className="text-xs lg:text-sm text-gray-600">
            ...
            <div className="bg-white rounded-xl p-5 lg:p-6 shadow-sm border border-gray-200">
              <Clock className="w-7 h-7 lg:w-8 lg:h-8 text-purple-600 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base">
                Rapide et simple
              </h3>
              <p className="text-xs lg:text-sm text-gray-600">
