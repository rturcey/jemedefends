      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-8 md:py-12">
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-2xl md:text-4xl font-bold mb-4">Contact et support</h1>
            <p className="text-blue-100 text-lg">Notre équipe est là pour vous accompagner</p>
          </div>
        </Container>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-xs text-gray-500 mt-2">Du lundi au vendredi, 9h-18h</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-xs text-gray-500 mt-2">Pour les clients ayant une commande</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700 text-sm">Tarnos, Nouvelle-Aquitaine</p>
              <p className="text-xs text-gray-500 mt-2">Équipe française, support en français</p>
            </div>
          </div>
