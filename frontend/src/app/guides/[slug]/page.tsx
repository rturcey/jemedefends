// ============================================================================
// CORRECTIF GUIDE PAGE - Utilise le nouveau système sections
// ============================================================================
...
import GuideHero from '@/components/guides/GuideHero'; // ✅ utilise le vrai composant

// Données YAML
import { getFullGuide } from '@/lib/guide-registry';
import LegalHydrator from '@/legal/LegalHydrator';
...
export default async function GuidePage({ params }: GuidePageProps) {
  ...
  return (
    <>
      ...
      {/* ✅ Hero fonctionnel (tu masquais le vrai composant avant) */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:[grid-template-columns:16rem_minmax(0,1fr)_20rem] gap-6 lg:gap-8">
          ...
          <main className="min-w-0">
            ...
            {/* ⬇️ Hydratation des exposants + blocs Sources (scope = main article) */}
            <LegalFootnotes scopeSelector="main article" />
            {/* Bouton d'édition dev */}
            <DevEditButton path={`/data/guides/${guide.category}/${slug}.yaml`} className="mt-4" />
          </main>
